...
const EXPORT_REDACTIONS: Record<string, string[]> = {
  ...
  crm_contract_signatures: ["ip_address", "user_agent", "audit_json"],
  ...
  try {
    ...
    const payload = {
      ...
      notes: [
        ...
        "Contract signer identity, signature text and consent remain part of the signed business record; signature IP address, user-agent and technical audit metadata are redacted.",
      ],
      tables,
    };
