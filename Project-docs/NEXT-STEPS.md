...
2. Activate the reserved download controls only after secure original authorization is live.
3. Generate controlled web previews/thumbnails in the background without exposing private originals.
4. Add secure original-file download authorization and full-gallery ZIP jobs.
5. Add client selections/shortlists alongside favourites and make them visible in Admin.
6. Allow selected client assets to be promoted into public Venue/Moment/Location/Custom Galleries without re-upload.
7. Progressively cut existing gallery managers over to canonical relationship writes only after parity is proven.
8. Begin CRM/client/job foundation after storage/access isolation and delivery workflows are proven.
