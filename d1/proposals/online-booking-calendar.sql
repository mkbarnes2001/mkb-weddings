-- Online booking/calendar candidate. Apply only to an isolated development DB.
-- Production remains schema 53 until this proposal is promoted in a release gate.
...
-- Private iCloud connection candidate; still isolated-development storage only.
