...
export const defaultAdminModuleConfigurations: PlatformModuleConfiguration[] = [
  { moduleKey: "crm", accentColor: "#2563EB", pageBackgroundColor: "#F5F3EF", sectionBackgroundColor: "#FFFFFF", recordBackgroundColor: "#FFFFFF", iconKey: "contact-round", markUrl: "", wordmarkUrl: "", darkWordmarkUrl: "", compactWordmarkUrl: "", activeButtonStyle: "solid", panelAccentStyle: "edge", status: "active", sortOrder: 10 },
  { moduleKey: "client-galleries", accentColor: "#7C3AED", pageBackgroundColor: "#F5F3EF", sectionBackgroundColor: "#FFFFFF", recordBackgroundColor: "#FFFFFF", iconKey: "images", markUrl: "", wordmarkUrl: "", darkWordmarkUrl: "", compactWordmarkUrl: "", activeButtonStyle: "soft", panelAccentStyle: "wash", status: "active", sortOrder: 20 },
  { moduleKey: "website", accentColor: "#0F766E", pageBackgroundColor: "#F5F3EF", sectionBackgroundColor: "#FFFFFF", recordBackgroundColor: "#FFFFFF", iconKey: "globe-2", markUrl: "", wordmarkUrl: "", darkWordmarkUrl: "", compactWordmarkUrl: "", activeButtonStyle: "solid", panelAccentStyle: "edge", status: "active", sortOrder: 30 },
  { moduleKey: "business", accentColor: "#B45309", pageBackgroundColor: "#F5F3EF", sectionBackgroundColor: "#FFFFFF", recordBackgroundColor: "#FFFFFF", iconKey: "briefcase-business", markUrl: "", wordmarkUrl: "", darkWordmarkUrl: "", compactWordmarkUrl: "", activeButtonStyle: "outline", panelAccentStyle: "header", status: "active", sortOrder: 40 },
];
