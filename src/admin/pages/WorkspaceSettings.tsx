...
export function WorkspaceSettings() {
  ...
  return (
    <AdminPage className="admin-refined-page">
      <AdminPageHeader
        eyebrow="Settings"
        title="Domains & workspace"
        description="Manage your workspace details, domains and regional defaults."
      ...
      <section className="grid grid-cols-1 gap-5 xl:grid-cols-[1.3fr_0.7fr]">
        <div className="admin-surface-card border border-black/10 bg-white/75">
          <div className="mb-7">
            ...
            <h2 className="admin-section-title mt-2">{workspace.name}</h2>
          ...
          <div className="mt-7 flex items-center gap-4">
            <AdminActionButton type="button" onClick={save} disabled={saving} className="admin-button admin-button--primary rounded-full bg-black px-6 py-3 text-sm text-white disabled:opacity-50">
