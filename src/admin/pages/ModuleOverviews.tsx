...
export function ClientGalleriesOverview() {
  ...
  return <AdminPage>
    ...
    <AdminPanel title="How this module is organised" description="Private client delivery remains separate from the Website module.">
      <div className="admin-module-guidance"><div><LockKeyhole /><span><strong>Gallery settings and branding</strong><small>Open an individual gallery to manage privacy, downloads, selections, albums, branding and store assignment.</small></span></div><div><CheckCircle2 /><span><strong>Client selections</strong><small>Favourites and formal selection requests remain attached to the gallery and its verified client identities.</small></span></div><div><Globe2 /><span><strong>Public portfolio content</strong><small>Website galleries, venues, moments and wedding stories are managed in the Website module.</small></span></div></div>
    </AdminPanel>
  </AdminPage>;
}
