...
function moduleFingerprint(module: PlatformModuleConfiguration) {
  return JSON.stringify({
    ...
    desktopNavBackgroundColor: module.desktopNavBackgroundColor,
    desktopNavTextColor: module.desktopNavTextColor,
    desktopNavButtonColor: module.desktopNavButtonColor,
    desktopNavActiveColor: module.desktopNavActiveColor,
    desktopNavActiveTextColor: module.desktopNavActiveTextColor,
    mobileNavBackgroundColor: module.mobileNavBackgroundColor,
    mobileNavTextColor: module.mobileNavTextColor,
    mobileNavButtonColor: module.mobileNavButtonColor,
    mobileNavActiveColor: module.mobileNavActiveColor,
    mobileNavActiveTextColor: module.mobileNavActiveTextColor,
    moduleFontScale: module.moduleFontScale,
    headingFontScale: module.headingFontScale,
    buttonFontScale: module.buttonFontScale,
    navigationFontScale: module.navigationFontScale,
    pageHeaderLogoScale: module.pageHeaderLogoScale,
    sidebarLogoScale: module.sidebarLogoScale,
    mobileLogoScale: module.mobileLogoScale,
...
function identityFingerprint(identity: PlatformBrandingIdentity) {
  return JSON.stringify({
    ...
    adminFontScale: identity.adminFontScale,
    adminHeadingFontScale: identity.adminHeadingFontScale,
    adminButtonFontScale: identity.adminButtonFontScale,
    adminNavigationFontScale: identity.adminNavigationFontScale,
    adminMetaFontScale: identity.adminMetaFontScale,
