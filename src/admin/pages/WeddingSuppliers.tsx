...
export function WeddingSuppliers() {
  ...
  return (
    <div className="space-y-7">
      ...
      {suppliers.length === 0 ? (
        <section className="rounded-[28px] border border-amber-200 bg-amber-50 p-7 text-amber-900"><div className="flex items-start gap-4"><Users className="w-6 h-6 mt-1" /><div><h2 className="text-2xl font-serif mb-2">No suppliers added yet</h2><p className="text-sm leading-relaxed">Open the supplier editor to create CSV-ready supplier rows.</p></div></div></section>
      ) : (
