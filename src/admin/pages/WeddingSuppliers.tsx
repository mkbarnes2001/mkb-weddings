...
export function WeddingSuppliers() {
  ...
  if (!wedding) return <div className="admin-surface-card border border-black/10 bg-white"><h1 className="admin-section-title mb-4">Wedding not found</h1><Link to="/admin/weddings" className="underline underline-offset-4">Back to weddings</Link></div>;
