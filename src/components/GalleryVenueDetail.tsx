...
// Your chosen primary site origin (www + https)
...
export function GalleryVenueDetail() {
  ...
  const description = meta?.venueDescription?.trim() || getFallbackVenueDescription(name, location);
  ...
  const pageJsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        itemListElement: breadcrumbsJsonLd.itemListElement,
      },
    ],
  };
